...
import io.cereebro.spring.cloud.autoconfigure.eureka.EurekaInstanceUrlPathSpringBootTest.EurekaInstanceUrlPathSpringBootTestConfiguration;
...
@SpringBootTest(classes = { EurekaInstanceUrlPathSpringBootTestConfiguration.class,
        CereebroEurekaInstanceAutoConfiguration.class }, webEnvironment = WebEnvironment.NONE, value = {
                "cereebro.eureka.instance.snitch.url-path=/snitch" })
