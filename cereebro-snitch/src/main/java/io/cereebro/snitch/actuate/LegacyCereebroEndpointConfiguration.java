...
@ConditionalOnClass({Endpoint.class, WebMvcConfigurer.class})
public class LegacyCereebroEndpointConfiguration {
    
    @Value("${management.endpoints.web.base-path:/actuator}")
    private String basePath;
    
    @Bean
    WebMvcConfigurer cereebroSnitchLegacyEndpointConfigurer() {
