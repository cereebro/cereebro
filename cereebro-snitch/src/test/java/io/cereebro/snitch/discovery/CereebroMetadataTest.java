...
/**
 * {@link CereebroMetadata} "unit tests".
 * 
 * @author michaeltecourt
 */
public class CereebroMetadataTest {
    ...
    public void colorPrivateConstructorInGreen() throws InstantiationException, IllegalAccessException,
        ...
        Constructor<CereebroMetadata> constructor = CereebroMetadata.class.getDeclaredConstructor();
